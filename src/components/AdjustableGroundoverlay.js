      ...
      <Grid container spacing={1}>
        <Grid item xs={12}>
          <MapWithGroundOverlay
            googleMapURL={`https://maps.googleapis.com/maps/api/js?key=AIzaSyCkhRL1huiPkUIg7nNVIc3rEDhech8-5mQ&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v7_cABDF`}
